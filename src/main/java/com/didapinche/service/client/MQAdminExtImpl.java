...
public class MQAdminExtImpl implements MQAdminExt {
    ...
    public void start() throws MQClientException {
        throw new IllegalStateException("thisMethod is deprecated.use  com.didapinche.aspect.admin.MQAdminAspect instead of this");
    }
    ...
    //新的接口方法。待实现
	@Override
	public void updateNameServerConfig(Properties properties, List<String> nameServers)
	...
	@Override
	public Map<String, Properties> getNameServerConfig(List<String> nameServers)
